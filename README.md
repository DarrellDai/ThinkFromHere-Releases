...
[直接下载 APK](https://raw.githubusercontent.com/DarrellDai/ForkChat-Releases/gh-pages/downloads/ForkChat-0.1.5-android-debug.apk)

- Android 7.0 及以上
- 文件大小约 27 MB
- Debug 签名
- SHA-256：`f4b4d4559822d703d0cf914395221538a659067fce3f4a0c7b8fca0728f76e25`

当前版本支持本地画布、分支聊天、智能画布命名、Provider、长期记忆、删除撤销，
以及与桌面端共用账号的双向云同步。用户添加的 API Key 也可以同步，下载到手机后由
Android Keystore 加密保存，且不会在界面回显。手机端点击方框时会同时显示详情和
底部输入框，不再需要额外点击“从这里继续聊”。
...
0.1.5 测试包使用 Debug 签名，不保证能覆盖其他签名的安装包。
