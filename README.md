...
- Windows x64：ThinkFromHere Desktop 0.1.40 EXE
- macOS Intel + Apple Silicon：ThinkFromHere Desktop 0.1.40 Universal DMG
- Linux x64：ThinkFromHere Desktop 0.1.40 DEB / TAR.GZ
