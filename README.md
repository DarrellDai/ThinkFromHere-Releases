...
- Windows x64：ThinkFromHere 0.1.14 EXE 安装程序
- macOS Intel + Apple Silicon：ThinkFromHere 0.1.14 Universal DMG
- Linux x64：ThinkFromHere 0.1.14 DEB
- Android 7.0 及以上：ThinkFromHere 0.1.23 Release APK
- iOS：ThinkFromHere 0.1.23 未签名模拟器 ZIP
...
- 文件大小约 25 MB
- 项目固定 Release 密钥签名
- SHA-256：`02896f237e317ce1d354758734c1afd19a3c830011b43c21cbded15df4908051`
...
`*.supabase.co` 导致“同步失败”。
桌面 0.1.14 也会隔离无法由 Electron SafeStorage 解密的旧 API Key 密文：云端有副本时
...
SHA-256：`ad7f306500d585c506cf5a882aa15df1367d3ea4835cece5661358e738adf739`

Linux 0.1.14 的 DEB 包名、安装摘要、应用菜单、可执行文件和应用图标均已统一为
