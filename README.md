...
- Windows x64：ThinkFromHere 0.1.12 EXE 安装程序
- macOS Intel + Apple Silicon：ThinkFromHere 0.1.12 Universal DMG
- Linux x64：ThinkFromHere 0.1.12 DEB
- Android 7.0 及以上：ThinkFromHere 0.1.21 Release APK
- iOS：ThinkFromHere 0.1.21 未签名模拟器 ZIP
...
- 文件大小约 25 MB
- 项目固定 Release 密钥签名
- SHA-256：`ec261d84ba6375944043f2acd532a7b64f3abbb09c54dc5c6f5a3e073cfcc6a7`
...
`*.supabase.co` 导致“同步失败”。
桌面 0.1.12 也会隔离无法由 Electron SafeStorage 解密的旧 API Key 密文：云端有副本时
...
SHA-256：`3a8c4894bc23e882645b740a1ba4ce514fd71dc9fe139c19f7834fbb01606362`

Linux 0.1.12 的 DEB 包名、安装摘要、应用菜单、可执行文件和应用图标均已统一为
