...
- Windows x64：ThinkFromHere 0.1.5 EXE 安装程序
- macOS Intel + Apple Silicon：ThinkFromHere 0.1.5 Universal DMG
- Linux x64：ThinkFromHere 0.1.5 DEB
- Android 7.0 及以上：ThinkFromHere 0.1.15 Release APK
- iOS：ThinkFromHere 0.1.15 未签名模拟器 ZIP
...
- 文件大小约 25 MB
- 项目固定 Release 密钥签名
- SHA-256：`27804e3894409f5d3943c24c24b88a05079ccb69bca250f299af6b77f41c650e`
...
Linux 0.1.5 的 DEB 包名、安装摘要、应用菜单和可执行文件均已统一为
