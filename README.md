...
- Windows x64：ThinkFromHere 0.1.15 EXE 安装程序
- macOS Intel + Apple Silicon：ThinkFromHere 0.1.15 Universal DMG
- Linux x64：ThinkFromHere 0.1.15 DEB
- Android 7.0 及以上：ThinkFromHere 0.1.24 Release APK
- iOS：ThinkFromHere 0.1.24 未签名模拟器 ZIP
...
- 文件大小约 25 MB
- 项目固定 Release 密钥签名
- SHA-256：`a457ee39753acb8336dd2501b8f0aa5f86a5a008587742bdc284a70ac3312dcb`
...
`*.supabase.co` 导致“同步失败”。
桌面 0.1.15 也会隔离无法由 Electron SafeStorage 解密的旧 API Key 密文：云端有副本时
...
SHA-256：`9560fddaad89dfb1e4007070647795d4f8af5987630673ef7a87b89170fba79c`

Linux 0.1.15 的 DEB 包名、安装摘要、应用菜单、可执行文件和应用图标均已统一为
