...
- Windows x64：ThinkFromHere 0.1.25 EXE 安装程序
- macOS Intel + Apple Silicon：ThinkFromHere 0.1.25 Universal DMG
- Linux x64：ThinkFromHere 0.1.25 DEB
...
- 文件大小约 25 MB
- 项目固定 Release 密钥签名
- SHA-256：`5af83f6db722bf797cd7b81fc0cf6e887774a1dc322a0743454ac95388c614da`
...
`*.supabase.co` 导致“同步失败”。
桌面 0.1.25 也会隔离无法由 Electron SafeStorage 解密的旧 API Key 密文：云端有副本时
...
SHA-256：`ec071e39e8b7168321cc863bcc166bc0b070a895b76cf926a1f7a622af50cc1c`

Linux 0.1.25 的 DEB 包名、安装摘要、应用菜单、可执行文件和应用图标均已统一为
