...
- Windows x64：ThinkFromHere 0.1.13 EXE 安装程序
- macOS Intel + Apple Silicon：ThinkFromHere 0.1.13 Universal DMG
- Linux x64：ThinkFromHere 0.1.13 DEB
- Android 7.0 及以上：ThinkFromHere 0.1.22 Release APK
- iOS：ThinkFromHere 0.1.22 未签名模拟器 ZIP
...
- 文件大小约 25 MB
- 项目固定 Release 密钥签名
- SHA-256：`3f075856006a1316b451a6126bdfc7f33ae1546224007df2dccf61524e25a22d`
...
DeepSeek V4 和 GLM 5.2，无需用户填写 API Key；国产模型现在会关闭不可见的深度思考，
直接消费真实 SSE 增量，豆包、DeepSeek V4 与 GLM 5.2 开启联网时也会优先使用单次
...
`*.supabase.co` 导致“同步失败”。
桌面 0.1.13 也会隔离无法由 Electron SafeStorage 解密的旧 API Key 密文：云端有副本时
...
SHA-256：`cce9cd112183819aa9af5d4453ad92820cb7d3dac8b13693627ca5edd1070645`

Linux 0.1.13 的 DEB 包名、安装摘要、应用菜单、可执行文件和应用图标均已统一为
